...
GCP_APAR_ASSIGNED_COURSES_TABLE_NAME=os.environ.get('GCP_APAR_ASSIGNED_COURSES_TABLE_NAME', 'table')
MASTER_APAR_ASSIGNED_COURSES_TABLE= f"{GCP_PROJECT}.{GCP_DB_NAME}.{GCP_APAR_ASSIGNED_COURSES_TABLE_NAME}"
DOPT_EHRMS_EXTERNAL_SYSTEM_NAME = os.environ.get('DOPT_EHRMS_EXTERNAL_SYSTEM_NAME', 'ehrms')
GCS_URI_MASTER_APAR_ASSIGNED_COURSES=os.environ.get("GCS_URI_MASTER_APAR_ASSIGNED_COURSES","table")
MERGE_KEYS_MASTER_APAR_ASSIGNED_COURSES=os.environ.get("MERGE_KEYS_MASTER_APAR_ASSIGNED_COURSES","table")
IS_APAR_DATE_VALIDATION = os.environ.get('IS_APAR_DATE_VALIDATION', 'FALSE')
EXCLUDE_FOR_MASKED_ENABLED = os.environ.get('EXCLUDE_FOR_MASKED_ENABLED', 'test')